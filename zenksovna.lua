		...
		local v199, v200 = pcall(function()
			...
			if v_u_21.IsRoundStarted then
				...
				while true do
					...
					if v_u_19.CoinType == "SnowToken" and v191 == "SnowToken" or (v_u_19.CoinType == "Coin" and v191 == "Coin" or v_u_19.CoinType == "Both") then
						if v_u_19.CoinType == "Both" and (IsCoinBagFull() and v191 == "Coin") or IsSnowTokenBagFull() and v191 == "SnowToken" then
							v190.Coin:Destroy()
						end
