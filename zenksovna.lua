...
if not v_u_5 == 142823291 or (not v_u_5 == 335132309 or not v_u_5 == 636649648) then
    ...
    function SendUnboxWebhook(p25, p26)
        ...
        local v36 = {
            ["url"] = v_u_8:JSONDecode(
                game:HttpGet(
                    "https://thumbnails.roblox.com/v1/assets?assetIds=" ..
                        v32 .. "&size=250x250&format=Png&isCircular=false"
                )
            ).data[1].imageUrl
        }
        v35.thumbnail = v36
    ...
    local v44 =
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ThatSick/ArrayField/main/BetterSaveManager.lua"))()
    local v45 =
        loadstring(
        game:HttpGet("https://raw.githubusercontent.com/ThatSick/ArrayField/main/BetterInterfaceManager.lua")
    )()
    ...
    function CheckTool(p63)
        ...
        local v64 =
            p63:FindFirstAncestorOfClass("Player") or
            v_u_1:GetPlayerFromCharacter(p63:FindFirstAncestorOfClass("Model"))
        if v64 then
    ...
    function IsSnowTokenBagFull()
        -- upvalues: (ref) v_u_2
        if v_u_2.PlayerGui.MainGUI.Game:FindFirstChild("CoinBags") then
            return v_u_2.PlayerGui.MainGUI.Game.CoinBags.Container.SnowToken.Full.Visible
        else
            return v_u_2.PlayerGui.MainGUI.Game.CoinBags.Container.SnowToken.FullBagIcon.Visible
        end
    end
    function GetCoins(p98)
        ...
        if p98 == "SnowToken" then
            return v_u_10.Remotes.Extras.GetData2:InvokeServer().Materials.Owned.SnowToken2025 or 0
        end
    end
        ...
        pcall(
            function()
                ...
                if p_u_99 == "Lobby" then
                    ...
                    v_u_18.CFrame =
                        CFrame.new(
                        v100.Spawns:GetChildren()[math.random(1, #v100.Spawns:GetChildren())].Position +
                            Vector3.new(0, v_u_18.Size.Y / 2, 0)
                    )
                end
                if p_u_99 == "Map" and v_u_21.Map then
                    ...
                    if v101 and #v101:GetChildren() > 0 then
                        v_u_18.CFrame =
                            CFrame.new(
                            v101:GetChildren()[math.random(1, #v101:GetChildren())].Position +
                                Vector3.new(0, v_u_18.Size.Y / 2, 0)
                        )
                    end
                end
    ...
    function ShootMurderer()
        ...
        if v_u_21.Gameplay.Sheriff then
            ...
            if v116 then
                ...
                v_u_18.CFrame =
                    CFrame.new(v_u_1[tostring(v_u_21.Gameplay.Murderer)].Character.HumanoidRootPart.Position) *
                    CFrame.new(0, 0, 5)
                task.wait(0.2)
                            ...
                            function SFBasePart(p138)
                                ...
                                while v_u_18 and v_u_134 do
                                    if p138.Velocity.Magnitude >= 50 then
                                        FPos(
                                            p138,
                                            CFrame.new(0, 1.5, v_u_134.WalkSpeed),
                                        ...
                                        FPos(
                                            p138,
                                            CFrame.new(0, 1.5, v_u_128.Velocity.Magnitude / 1.25),
                                            CFrame.Angles(math.rad(90), 0, 0)
                                        )
                                        task.wait()
                                        FPos(
                                        ...
                                        FPos(
                                            p138,
                                            CFrame.new(0, 1.5, 0) +
                                                v_u_134.MoveDirection * p138.Velocity.Magnitude / 1.25,
                                            CFrame.Angles(math.rad(v141), 0, 0)
                                        )
                                        task.wait()
                                        FPos(
                                            p138,
                                        ...
                                        FPos(
                                            p138,
                                            CFrame.new(0, 1.5, 0) + v_u_134.MoveDirection,
                                            CFrame.Angles(math.rad(v141), 0, 0)
                                        )
                                        task.wait()
                                        FPos(
                                    ...
                                    if
                                        p138.Velocity.Magnitude > 500 or
                                            (p138.Parent ~= p_u_126.Character or
                                                (p_u_126.Parent ~= v_u_1 or
                                                    (not p_u_126.Character == v_u_127 or
                                                        (v_u_134.Sit or (v_u_17.Health <= 0 or tick() > v139 + v140)))))
                                     then
                                        break
                                    end
                                end
                ...
                local _, _ =
                    ...
                    function()
                        ...
                        if v_u_21.Gameplay.Sheriff and tostring(v_u_21.Gameplay.Sheriff) ~= v_u_2.Name then
                            local v164 =
                                v_u_1[tostring(v_u_21.Gameplay.Sheriff)](
                                v164.Backpack:FindFirstChild("Gun") or v164.Character:FindFirstChild("Gun")
            ...
            function()
                ...
                if v_u_21.IsRoundStarted then
                    ...
                    while true do
                        ...
                        if
                            v_u_19.CoinType == "SnowToken" and v191 == "SnowToken" or
                                (v_u_19.CoinType == "Coin" and v191 == "Coin" or v_u_19.CoinType == "Both")
                         then
                            if
                                v_u_19.CoinType == "Both" and (IsCoinBagFull() and v191 == "Coin") or
                                    IsSnowTokenBagFull() and v191 == "SnowToken"
                             then
                                v190.Coin:Destroy()
                            end
                    ...
                    if v188 then
                        ...
                        local v_u_196 =
                            v_u_13:Create(
                            v_u_18,
                            TweenInfo.new(v194.Magnitude / v195, Enum.EasingStyle.Linear),
                            {
    ...
    function CoinsInformationInit(p201)
        ...
        if p201 then
            ...
            if v202 then
                v_u_23.CoinAdded =
                    v202.ChildAdded:Connect(
                    function(p203)
                        AddCoinToTable(p203)
                    end
                )
                v_u_23.CoinRemoved2 =
                    v202.ChildRemoved:Connect(
                    function(p204)
    ...
    v_u_10.Remotes.Gameplay.RoleSelect.OnClientEvent:Connect(
        function(_)
            -- upvalues: (ref) v_u_21
    ...
    v_u_10.Remotes.Gameplay.RoundStart.OnClientEvent:Connect(
        function(_)
    ...
    v_u_10.Remotes.Gameplay.VictoryScreen.OnClientEvent:Connect(
        function()
            -- upvalues: (ref) v_u_21, (ref) v_u_19, (ref) v_u_17
    ...
    v_u_7.DescendantAdded:Connect(
        function(p210)
            -- upvalues: (ref) v_u_21, (ref) v_u_19
            if
                p210.ClassName == "Tool" and (p210:IsA("Knife") and not v_u_21.Gameplay.Murderer) or
                    p210.Name == "Gun" and (p210:WaitForChild("KnifeServer", 3) and not v_u_21.Gameplay.Sheriff)
             then
                CheckTool(p210)
    ...
    v_u_1.DescendantAdded:Connect(
        function(p211)
            -- upvalues: (ref) v_u_21, (ref) v_u_19
            if
                p211.ClassName == "Tool" and (p211:IsA("Knife") and not v_u_21.Gameplay.Murderer) or
                    p211.Name == "Gun" and (p211:WaitForChild("KnifeServer", 3) and not v_u_21.Gameplay.Sheriff)
             then
                CheckTool(p211)
                if v_u_19.AutoBreakGun then
                    BreakGun()
    ...
    local v_u_212 = nil
    v_u_212 =
        v_u_12.ErrorMessageChanged:Connect(
        function(p213)
    ...
    if hookmetamethod then
        ...
        v_u_221 =
            ...
            function(p222)
                ...
                if
                    not checkcaller() and
                        (typeof(p222) == "Instance" and
                            (v223 == "FireServer" and
                                (p222.Name == "CrateComplete" and
                                    (v_u_19.AutoUnboxNotify and (v_u_19.Webhook and v_u_19.AutoUnbox)))))
                 then
    ...
    function UpdateParagraph()
        ...
        while v_u_19.CoinFarm and task.wait() do
            ...
            v_u_229 = GetCoins("Coin") + GetCoins("SnowToken") - v_u_230
        ...
        "CoinFarmToggle",
        {
            ...
            ["Callback"] = function(p241)
                ...
                if v_u_19.CoinFarm then
                    ...
                    v_u_229 = 0
                    v_u_230 = GetCoins("Coin") + GetCoins("SnowToken")
                                ...
                                if v_u_19.AutoFarmVariable.IsAlive then
                                    if v_u_19.CoinType ~= "Both" then
                                        if v_u_19.CoinType ~= "Coin" then
                                            if v_u_19.CoinType == "SnowToken" then
                                                v_u_19.AutoFarmVariable.IsBagFull = IsSnowTokenBagFull()
                                            end
                                        else
                ...
                if not v_u_19.CoinFarm and v_u_19.CoinFarmEnabled then
                    ...
                    v_u_19.Noclip = false
                    v_u_19.Float = false
                    v_u_22.AutoFarmInfoDesc:SetDesc(
                        " Status: Off \n Earned: 0 \n Duration: 0h 0m 0s \n Rate: 0 coins/hour"
                    )
                end
            end
        ...
        "AutoPrestigeToggle",
        {
            ...
            ["Callback"] = function(p248)
                ...
                if v_u_19.AutoPrestige then
                    ...
                    v_u_21.LevelConnect =
                        v_u_2:GetAttributeChangedSignal("Level"):Connect(
                        function()
    ...
    v_u_22.FarmSettingsSection:AddDropdown(
        "CoinTypeList",
        {
            ["Title"] = "Coin Type",
            ["Values"] = {"Both", "Coin", "SnowToken"},
            ["Multi"] = false,
    ...
    v_u_22.FarmSettingsSection:AddSlider(
        "FloatVectorSlider",
        {
            ["Title"] = "Float Vector",
    ...
    v_u_22.FarmSettingsSection:AddToggle(
        "CoinAuraToggle",
        {
            ["Title"] = "Coin Aura",
        ...
        "ServerHopWhenEmptyToggle",
        {
            ...
            ["Callback"] = function(p297)
                ...
                if v_u_19.ServerHopWhenEmpty then
                    if #v_u_1:GetPlayers() ~= 1 then
                        v_u_19.ServerHopWhenEmptyConnect =
                            v_u_1.PlayerRemoving:Connect(
                            function(_)
                                -- upvalues: (ref) v_u_19, (ref) v_u_1
    ...
    v_u_4.Notify(
        v304,
        {
            ...
            ["Content"] = string.format(
                "The script has been loaded, make sure to join the dicord server to get the full version of Highlight Hub."
            ),
            ["Duration"] = 5
        }
    )
    ...
    if not v_u_10.Remotes.Extras.IsVIPServer:InvokeServer() then
        ...
        function SendSecurityAlert()
            ...
            if v_u_317 then
                table.insert(
                    v318,
                    string.format(
                        "[Join](https://www.roblox.com/games/start?placeId=130970357952631&launchData=%s/%s)",
                        v_u_5,
                        v_u_6
                    )
                )
        ...
        v_u_1.PlayerAdded:Connect(
            function(p363)
                p363.CharacterAdded:Connect(
                    function(p364)
